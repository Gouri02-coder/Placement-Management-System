...
let InterviewFeedbackComponent = class InterviewFeedbackComponent {
    feedbackList = [];
    ...
    updateFeedbackRating(category, value) {
        this.newFeedback.feedback[category] = value;
    }
    getFeedbackRating(category) {
        return this.newFeedback.feedback[category] || 0;
    }
};
InterviewFeedbackComponent = __decorate([
    Component({
...
export { InterviewFeedbackComponent };
